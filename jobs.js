function customdiv(element) {
  ...
  var inner = document.createElement("div"); //new div for all data
  ...
  ahref.href = `details.html?id=${element.jobid}`;
  // console.log(ahref);
  ...
  inner.appendChild(h2); //appending the div
  ...
  inner.appendChild(locational);
  jobtitles.appendChild(inner);
  ...
  jobtitles.appendChild(rightside);
}
